<section class="main-sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="">
            <a href="categorias"><i class="fa fa-th"></i><span>Categorias</span></a>
        </li>
        <li class="">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li>
                    <a href="ventas"><i class="fa fa-file-o"></i>
                    <span>Administrar Ventas</span>
                    </a>
                </li>
                <li>
                    <a href="crear-venta"><i class="fa fa-money"></i>
                        <span>Crear Venta</span>
                    </a>
                </li>
                <li>
                    <a href="reportes"><i class="fa fa-line-chart"></i>
